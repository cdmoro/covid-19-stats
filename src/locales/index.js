export default {
  ...
  es: {
    ...
    translation: {
      ...
      'reset-position': 'Posición inicial',
  ...
  it: {
    ...
    translation: {
      ...
      deaths: 'Morti',
      'last-updated': 'Ultimo aggiornamiento',
  ...
  gr: {
    ...
    translation: {
      ...
      'provided-by': 'Παρέχεται από',
      'powered-by': 'Φτιαγμένο από',
      'change-theme': 'Αλλαξε θέμα',
      'reset-position': 'Επαναφορά θέσης',
  ...
  ru: {
    ...
    translation: {
      ...
      'powered-by': 'Сделанно в',
      'change-theme': 'Поменять тематику',
  ...
  vn: {
    ...
    translation: {
      ...
      'powered-by': 'Được làm bởi',
      'change-theme': 'Thay đổi nền',
