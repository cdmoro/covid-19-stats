        ...
        <div className="Footer mt-2 text-xs text-muted text-center">
            <div className="flex flex-col md:flex-row justify-center items-center mt-2">
                ...
                <div>
                    ...
                    <a className="md:hidden inline-block underline hover:no-underline" href="https://github.com/cdmoro/covid-19-stats" target="_blank" rel="noopener noreferrer">GitHub</a>
                </div>
            </div>
        </div>
    )
